...
class ReceitaAdmin(admin.ModelAdmin):
   list_display =  ('nome_receita', 'ingredientes', 'modo_preparo', 'tempo_preparo', 'rendimento', 'categoria', 'date_receita', 'publicada', )
   list_display_links = ('nome_receita', 'ingredientes', ) #Linka para o abrir o editar
   #filtros
   search_fields = ('nome_receita',) #Buscar, por escrito
   list_editable = ('publicada',) #Editável no dashboard
